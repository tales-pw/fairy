...
public abstract class FeaturedBlock extends Block {
    ...
    public FeaturedBlock(Properties properties) {
        super(properties);
    ...
    public BlockState updateShape(
        ...
        for (Feature feature : features) {
            state = feature.updateShape(state, this, world, pos);
        }
    ...
    public BlockState getStateForPlacement(
            BlockItemUseContext itemUseContext
    ) {
    ...
    protected void createBlockStateDefinition(
            StateContainer.Builder<Block, BlockState> stateContainerBuilder
    ) {
